...
def validate(data):
    ...
    if t == 0 or p == 0:
        print("  WARNING: empty teams/pool -- NCS schedule may not be posted or markup may have changed.", file=sys.stderr)
...
def main():
    ...
    ap.add_argument("--name", default="3P Sports Dingers for Dads *6GG*")
    ap.add_argument("--venue", default="Taylor/Lorena")
    ap.add_argument("--city", default="Taylor/Lorena, TX")
    ap.add_argument("--dates", default="Jun 20-21, 2026")
    args = ap.parse_args()
